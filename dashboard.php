              ...
              <div class="tab-pane fade show active" id="category" role="tabpanel" >
                  ...
                  <div class="total_amount py-3" style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <div>
                      ...
                      <input type="submit" class="btn btn-primary form-control w-25" name="place_order" id="submit_btn" value="Place Order" <?php if(!isset($_SESSION['e_cat_id'])) { ?> disabled <?php } ?> >
