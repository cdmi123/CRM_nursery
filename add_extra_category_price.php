              	 		...
              	 		<div class="col-md-4">
                  			<div class="form-group">
                    			<label for="exampleInputEmail1">Select Category:</label>
                    				<select class="form-control" name="selct_cat_id" id="cat_id">
                  		...
                  		<div class="col-md-4">
                  			<div class="form-group">
                    			<label for="exampleInputEmail1">Price:</label>
                    				<input type="text" class="form-control" id="sub_cat_price" placeholder="Enter category price" name="sub_cat_extra_price">
                  			</div>
                  		</div>
                 	</div>
              	</div>
